	...
	public class SpeechLogGump : Gump
	{
			...
			: base( 500, 30 )
		{
			...
			string playerAccount = player.Account is Account ? player.Account.Username : "???";
                        ...
                        AddHtml( 10, 10, 280, 20, String.Format( "<basefont color=#A0A0FF><center>REGISTRO DE CHAT - {0} (<i>{1}</i>)</center></basefont>", playerName, Utility.FixHtml( playerAccount ) ), false, false );
			...
			if ( page > 0 )
				AddButton( 10, 395, 0xFAE, 0xFB0, 1, GumpButtonType.Reply, 0 ); // Previous page
                        ...
                        AddLabel( 45, 395, 0x481, String.Format( "Página actual: {0}/{1}", page + 1, lastPage + 1 ) );
