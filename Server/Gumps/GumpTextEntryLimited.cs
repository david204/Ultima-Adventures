...
namespace Server.Gumps {
	public class GumpTextEntryLimited : GumpEntry {
		...
		public override string Compile() {
                        return String.Format( "{{ textentrylimited {0} {1} {2} {3} {4} {5} {6} {7} }}", m_X, m_Y, m_Width, m_Height, m_Hue, m_EntryID, Parent.Intern( TranslationService.Translate( m_InitialText ) ), m_Size );
		}
		...
		public override void AppendTo( IGumpWriter disp ) {
			...
			disp.AppendLayout( m_Height );
                        ...
                        disp.AppendLayout( Parent.Intern( TranslationService.Translate( m_InitialText ) ) );
